...
----
 * Fix bugs.
 * Instead of the `bspc/bspwm` approach to rules, etc., just allow live-reload of config like [this](https://dwm.suckless.org/patches/restartsig/dwm-restartsig-20180523-6.2.diff).
 * Specify startup commands in `config.h`.
